...
import { GroupsToolView } from "@/features/teacher/components/tools/GroupsToolView";
import type { CourseWithStudents } from "@/features/teacher/components/TeacherToolsView";

export default async function GroupsToolPage() {
    ...
    return <GroupsToolView courses={formattedCourses} />;
}
