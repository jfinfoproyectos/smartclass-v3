...
import { RouletteToolView } from "@/features/teacher/components/tools/RouletteToolView";
import type { CourseWithStudents } from "@/features/teacher/components/TeacherToolsView";

export default async function RouletteToolPage() {
    ...
    return <RouletteToolView courses={formattedCourses} />;
}
